...
const Hero = () => {
  return (
    <div
      className="hero-section lg:h-[440px] bg-cover bg-center relative flex flex-col justify-between p-5 lg:px-36 lg:py-16"
      style={{
        backgroundImage: `url(${heroBg})`,
      }}
    >
      <div className="absolute inset-0 bg-[#193570] opacity-50"></div>
      <div className="relative left lg:w-6/12 text-white">
